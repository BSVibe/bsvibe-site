...
const C = {
  ko: {
    ...
    list: {
      ...
      formExpiresLabel: '만료 (초)',
      formExpiresHelp: '비워두면 서버 기본값. 30일 = 2592000',
      formSubmit: '발급',
      formCancel: '취소',
  ...
  en: {
    ...
    list: {
      ...
      formExpiresLabel: 'Expires in (seconds)',
      formExpiresHelp: 'Leave blank for server default. 30 days = 2592000.',
      formSubmit: 'Issue',
      formCancel: 'Cancel',
