...
- [Core Concepts](/en/bsgateway/concepts) — The 4-stage routing pipeline and how the classifier works
- [Routing Rules](/en/bsgateway/features/routing) — Pattern matching, aliases, and auto routing configuration
- [API Key Management](/en/bsgateway/features/api-keys) — Rate limiting, key security, and usage tracking
- [Configuration Guide](/en/bsgateway/configuration) — Model management, CORS, and API endpoint reference
