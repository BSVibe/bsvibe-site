...
- [Core Concepts](/en/bsage/concepts) — Understand plugins vs skills, the Knowledge Graph, and the 2nd Brain structure
- [Plugin Guide](/en/bsage/features/plugins) — Detailed setup guide for all 18 plugins
