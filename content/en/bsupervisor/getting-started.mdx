...
- [Core Concepts](/en/bsupervisor/concepts) — Understand event collection, the rule engine, and cost tracking architecture
- [Rule Management](/en/bsupervisor/features/rules) — Detailed guide to creating and managing custom rules
