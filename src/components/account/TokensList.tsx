  ...
  return (
    <>
      ...
      {/*
        ...
        dashboard. Claude Code (and any MCP client) obtains them via OAuth
        2.0 authorization_code + PKCE against auth.bsvibe.dev. This page
        only lists + revokes tokens that already exist. Service-account
        provisioning (bsv_sk_* via client_credentials) is a planned
        follow-up UI.
      */}
