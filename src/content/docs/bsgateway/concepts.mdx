...
별칭을 통해 모델을 참조할 수 있습니다. 대시보드의 **Routing → Aliases** 탭에서 설정합니다.

> **[스크린샷]** 대시보드 → Routing → Aliases 설정 화면
...
glob 패턴으로 요청 내용에 따라 라우팅합니다. 대시보드의 **Routing → Pattern Rules** 탭에서 관리합니다.

> **[스크린샷]** 대시보드 → Routing → Pattern Rules 설정 화면
